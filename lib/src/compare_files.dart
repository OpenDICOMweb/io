...
final log = new Logger('FileCompare', logLevel: Level.debug);

/// Compare two files byte by byte and report the first significant difference.
List<List> compareFiles(String path0, String path1) {
  ...
  if (result.length == 1) {
    ...
    log.debug('Files are differend only in Null and Space');
