...
void main(List<String> args) {
  ...
  final startTime = Timestamp('Start Time:');
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    log
      ..down
      ..debug('rds0: $rds0')
      //log.debug1(instance0.format( Formatter(maxDepth: -1)));
      ..up;
    ...
    log
      ...
      ..debug1(rds1.format(Formatter(maxDepth: -1)), -1)
  ...
  final endTime = Timestamp('End Time:');
